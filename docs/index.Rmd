...
```{r, out.width="70%", fig.cap="Imagem do Livro ['Ciência de Dados em R'](https://livro.curso-r.com/) da Curso-R."}
...
- [Beatriz Milz](https://beatrizmilz.com/) pelo apoio e ajuda com o xaringan.
